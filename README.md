...
```
cd existing_repo
git remote add origin https://forgemia.inra.fr/imhorphen/catdes.git
git branch -M main
...
- [ ] [Set up project integrations](https://forgemia.inra.fr/imhorphen/catdes/-/settings/integrations)
