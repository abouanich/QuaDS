...
if __name__ =="__main__" : 
	...
	df2 = pd.read_csv(r'kmeans_semantic_cluster_coordinates6.csv', 
	...
	quanti_a = quanti_analysis(sdquanti, dataframe_quanti,'Number_of_flowers_by_volume', 'cluster',0.05,0.05)
	
	#out :
	sdquanti = sdquanti.rename_axis('file : 20220520_florhige_synthese_english, code : 20220520_sdqua')
	sdquanti.to_csv('semantic_anova_cluster6_kmeans.csv')
	quanti_a = quanti_a.rename_axis('file : 20220520_florhige_synthese_english, code : 20220520_sdqua')
